			...
			<div class="content_area">
				...
				<div class="phone_wrap">
					...
					<div class="phone_input_box">
						<input class="phone_input" name="memberPhone" value="${mypageDetail.memberPhone}">
					</div>
				</div>
				<div class="id_wrap">
				...
				<div class="pw_wrap">
					...
					<div class="pw_input_box">
						<input type="password" class="pw_input" name="memberPw" value="${mypageDetail.memberPw}">
					</div>
				</div>
				<div class="email_wrap">
					<div class="email_name">이메일</div>
					<div class="email">
						<input class="email" name="memberEmail" value="${mypageDetail.memberEmail}">
					</div>
				</div>
			</div>
		</div>
