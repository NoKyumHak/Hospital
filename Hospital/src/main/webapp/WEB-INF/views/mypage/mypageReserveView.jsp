			...
			<div class="wrap">
				...
				<div class="idnum_wrap">
					...
					<div class="idnum_input_box">
						<input class="idnum_input" name="memberIDNum" maxlength="14" readonly="readonly" value="${reserveDetail.memberIDNum}">
					</div>
				</div>
				...
				<div class="subject_wrap">
					...
					<div class="subject_input_box">
						<input class="subject_input" name="subject" readonly="readonly" value="${reserveDetail.subject }">
					</div>
				</div>
				<div class="checkDate_wrap">
					<div class="checkDate_name">진료 희망일</div>
					<input class="checkDate_input" name="checkDate" readonly="readonly" value="${reserveDetail.checkDate }">
				</div>
				<div class="checkTime_wrap">
					<div class="checkTime_name">진료 희망시간</div>
					<div class="checkTime_input_box">
						<input class="checkTime_input" name="checkTime" readonly="readonly" value="${reserveDetail.checkTime }">
					</div>
				</div>
